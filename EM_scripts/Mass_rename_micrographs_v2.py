...
micrographs_dir = '/processing/michael/20160211_NucleoXlink/relion/Micrographs'
data_folder = '/local_storage/michael/20160211_NucleoXlink/original_data'
try:
    assert os.path.isdir(micrographs_dir)
    assert os.path.isdir(data_folder)
except AssertionError:
    print ('Please make sure starting and destinaiton directory exist')
    sys.exit()

project_name = '20160211_NucleoXlink'
folder_pattern = re.compile('/Data/FoilHole')
frames_pattern = re.compile('_frames_n')
micrographs = []
frames = True
overwrite = True
verbose = True
