...
def create_eman2_folder_names(user, project, eman2_folder, relion_folder):
    '''
    Creates the following tree:
    /processing/user/project/eman2/
    /processing/user/project/eman2/micrographs
    /local_storage/user/project/eman2/
    symbolic links:
    ...
    dirs_to_create.append(base_eman2_path_processing)
    dirs_to_create.append(os.path.join(base_eman2_path_processing, 'micrographs'))
    links_to_create.append((os.path.join(base_eman2_path_processing, 'micrographs')),  \
